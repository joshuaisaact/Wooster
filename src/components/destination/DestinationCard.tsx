...
export function DestinationCard({ destination, onClick }: DestinationCardProps) {
  ...
  return (
    <Card
      className="group h-full overflow-hidden border-none bg-white/70 shadow-lg transition-all duration-200 hover:bg-white/80 hover:shadow-xl dark:bg-green-800/30 dark:shadow-green-900/20 dark:hover:bg-green-800/40"
      onClick={onClick}
    >
